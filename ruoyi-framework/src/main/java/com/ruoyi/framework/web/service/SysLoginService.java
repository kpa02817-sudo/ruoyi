...
public class SysLoginService {
    ...
    public String login(String username, String password, String code, String uuid) {
        ...
        // 使用 Sa-Token 进行登录
        cn.dev33.satoken.stp.StpUtil.login(loginUser.getUserId());
        // 将用户信息存入 Sa-Token Session
        cn.dev33.satoken.stp.StpUtil.getSession().set("loginUser", loginUser);

        // 返回 token（Sa-Token 会根据 is-write 和 token-prefix 配置自动添加 Bearer 前缀）
